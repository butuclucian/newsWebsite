    ...
    <div className='text-center mt-10 mb-10 text-black text-2xl font-bold items-center'>
      <div className='text-center text-black text-2xl font-bold items-center'>
        ...
        <div className="flex justify-between items-center px-10">
          <p className="mb-10 text-5xl flex-grow text-center">Article List</p>
        ...
        <div className="flex flex-col gap-3">
          <div className="hidden md:grid grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center py-5 text-md px-20">
            <b>Image</b>
            <b>Title</b>
            <b>Category</b>
            <b>Date</b>
          ...
          {sortedArticles.length === 0 ? (
            ...
            sortedArticles.map((article, index) => (
              <div  key={index} 
                className="grid grid-cols-[1fr_3fr_1fr] md:grid-cols-[1fr_3fr_1fr_1fr_1fr] items-center gap-2 py-5 px-20 border text-sm">
                <img className="w-50 rounded-md max-h-30 object-cover" src={article.image} alt={article.title} />
                <p>{article.title}</p>
                <p>{article.section}</p>
